  ...
  <div className="thin flex">
    <div className="icon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        ...
        <path
          class="outer"
          d="M70,49l10-5L50,29,20,44l10,5V59c0,5.53,9,10,20,10s20-4.47,20-10Z"
        />
        <path
          class="tail"
          d="M46,44.5A4.5,2.5 0,1,1 55,44.5A4.5,2.5 0,1,1 46,44.5"
        />
        <path class="tail" d="M46,44L20,43.99L20,69" />
    ...
    <div className="icon">
      ...
      >
        ...
        <path fill="none" d="M43.5,71.8L56.6,71.8" />
        <path fill="none" d="M43.5,76.9L56.6,76.9" />
        <path className="spark" d="M50.1,28.5L50.1,22.1" />
        <path className="spark" d="M36,34.1L31.3,29.5" />
        <path className="spark" d="M30.2,47.5L23.5,47.5" />
        <path className="spark" d="M35.9,61L31.2,65.6" />
        <path className="spark" d="M64,61.1L68.7,65.7" />
        <path className="spark" d="M69.8,47.6L76.5,47.6" />
        <path className="spark" d="M64.1,34.1L68.8,29.6" />
      </svg>
